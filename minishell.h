...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/21 16:49:11 by ocapers           #+#    #+#             */
/*   Updated: 2022/06/21 17:09:02 by ocapers          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		execute_cmds(t_cmds **cmds, t_shell **shell,
				char **envp, char *line);
...
void		built_ins(t_envlist **list, t_cmds *cmds,
...
pid_t		watch_child_process(t_shell **shell, t_cmds **cmds,
				int in, char **envp);
...
void		get_command_position(t_cmds *cmd, t_shell **shell,
				int cmd_pos, int in);
